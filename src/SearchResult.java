...
public class SearchResult extends javax.swing.JDialog {
    ...
    public SearchResult(java.awt.Frame parent, boolean modal) {
        ...
        parentN = (Main) parent;
        initComponents();
        pan = (NewJPanel) parentN.getPanelByQ();
        this.setLocationRelativeTo(null);
        
        jLabel1.setText("Type: " + pan.getTypePa());//lấy type dữ liệu
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String keySearch = jTextField1.getText().trim();
        String textArea = jTextArea1.getText();
        
        String result = pan.SearchMethod(keySearch);// lấy kết quả về
